import type { HeatpumpData } from "./modbus/modbus-types";
import type { HeatpumpRecord } from "./schema";
...
export function mapHeatpumpDataToRecord(
  modbusData: HeatpumpData,
  shellyData: ShellyEMStatus,
): HeatpumpRecord {
  return {
    ...
    heatpump_actual_heating_capacity: modbusData.Heatpump_ActualHeatingCapacity,
    ...
    heatpump_energy_source_inlet_temp: modbusData.Heatpump_EnergySourceInletTemp,
    ...
    external_energy_data: shellyData.total_act_power ?? 0,
  };
}

export default mapHeatpumpDataToRecord;
